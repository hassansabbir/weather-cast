...
const PressureChart = ({weather , currentWeather ,currentWeather1,currentWeather2,currentWeather3,currentWeather4, currentWeather5,currentWeather6 ,currentWeather7 }) => {
    ...
    return (
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="Pressure" stackId="1" stroke="#82ca9d" fill="#82ca9d" />
