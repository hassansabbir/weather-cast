        ...
        <div>
            ...
            <div className="hero min-h-[500px] bg-base-200">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <Image className="w-[600px] h-[600px] rounded-full shadow-2xl" src={contactImg} alt='contact' />
                    <div>
                        <h1 className="text-5xl font-bold mb-5">Contact Us</h1>
                        <p className='font-bold'>Get in touch with us for any inquiries or feedback about our weather forecast web app. We are here to assist you</p>
            ...
            <div className="container my-24 mx-auto md:px-6">
                ...
                <section className="mb-32">
                    <div
                        className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat bg-[url('https://i.ibb.co/1QMJd4s/footer-bg.png')]">
                    </div>
                    <div className="container px-6 md:px-12">
                        <div
                            className="block rounded-lg bg-white px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                            <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <div className="mx-auto mb-12 text-center lg:mb-0">
                                    ...
                                    <h6 className="font-medium">Chattogram, 4203</h6>
                                </div>
                                <div className="mx-auto mb-6 text-center md:mb-0">
                                    ...
                                    <h6 className="font-medium">+ 8801819968181</h6>
                                </div>
                            ...
                            <div className="mx-auto max-w-[700px]">
                                <form>
                                    ...
                                    <button type="button" data-te-ripple-init data-te-ripple-color="light"
                                        className="inline-block w-full rounded bg-blue-950 px-6 pt-2.5 pb-2 text-xs font-medium uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] lg:mb-0">
                                        Send
                                    </button>
                                </form>
                            </div>
