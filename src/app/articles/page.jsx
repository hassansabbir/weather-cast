...
const articlesPage = () => {
  ...
  return (
    <div className="articlesBg">
      <div className="max-w-[1460px] mx-auto pb-20">
        ...
        <div className="text-center my-10">
          <h2 className="text-2xl font-bold">
            Wanna Publish Your Own Articles?
          </h2>
        ...
        <p className="text-xl px-5 w-10/12 mx-auto text-center my-10">
          ...
          more. Whether you're a weather enthusiast, a student, or simply
          curious about the forces shaping our world, these articles offer
          valuable insights and knowledge. Dive in to discover the fascinating
          world of weather and its impact on our lives.
        </p>
        <div
            ...
            >
              ...
              <div className="mt-5 flex justify-center">
                <Link href={`/articles/${article._id}`}>
                  <button className="btn bg-blue-800 hover:bg-blue-500 text-white">
                    View Details
                  </button>
                </Link>
              </div>
