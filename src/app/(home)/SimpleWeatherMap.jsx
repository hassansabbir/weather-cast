...
function WeatherMap() {
  ...
  useEffect(() => {
    ...
    const windSpeedApiUrl = 'https://openweathermap.org/weathermap?basemap=map&cities=false&layer=radar&lat=30&lon=-20&zoom=3';
  ...
  <Popup
    ...
    closeButton={false}  onClick={handlePopupClick}
  >
